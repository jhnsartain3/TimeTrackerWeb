...
namespace TimeTrackerWeb.Controllers
{
    public class EventController : BaseDataAccessController<EventModel>
    {
        ...
        public async Task<IActionResult> Index(string id)
        {
            ...
            _loggerWrapper.LogInformation("id: " + id, GetType().Name, nameof(Index) + "()", null);

            return View(await GetAllById<EventModelWithQuantitiesOfTimeAndDateTimeInfoHeaders>(
                TimeTrackerApiSubPath + "/ByProjectIdSinceSundayWithQuantitiesOfTimeAndDateTimeInfoHeaders", id,
        ...
        public async Task<IActionResult> AllRecords(string id)
        {
            ...
            _loggerWrapper.LogInformation("id: " + id, GetType().Name, nameof(AllRecords) + "()", null);

            return View(await GetAllById<EventModelWithQuantitiesOfTimeAndDateTimeInfoHeaders>(
                TimeTrackerApiSubPath + "/GetAllByIdWithQuantitiesOfTimeAndDateTimeInfoHeaders", id,
                GetAuthenticationTokenFromSession()));
        }
        ...
        {
            _loggerWrapper.LogInformation("id: " + id, GetType().Name, nameof(Create) + "()", null);
        ...
        {
            _loggerWrapper.LogInformation("id: " + id + " " + "projectId: " + projectId, GetType().Name, nameof(DeleteConfirmed) + "()", null);
        ...
        {
            _loggerWrapper.LogInformation("id: " + id, GetType().Name, nameof(Stop) + "()", null);
        ...
        {
            _loggerWrapper.LogInformation("id: " + id, GetType().Name, nameof(Start) + "()", null);
